...
public class RegistrationController {
    ...
    public ResponseEntity<?> registerUser(@RequestBody SignUpRequestDto signUpRequest) {
        try {
            ...
            return ResponseEntity.internalServerError().body(new ErrorResponse("An error occurred during registration"));
        }
    }
    ...
    public ResponseEntity<?> loginUser(@RequestBody LoginRequestDto loginRequest) { 
        try {
            ...
            return ResponseEntity.internalServerError().body(new ErrorResponse("An error during the login process occurred"));        
        }
    }
