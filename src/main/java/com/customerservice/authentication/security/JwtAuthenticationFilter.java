...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
  // This class will be responsible for filtering incoming requests and performing JWT
  // authentication.
  ...
  private void sendErrorResponse(HttpServletResponse response, String message, int status)
    ...
    response
        ...
        .write(
            new ObjectMapper()
                .writeValueAsString(java.util.Collections.singletonMap("message", message)));
  }
}
